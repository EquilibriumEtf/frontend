...
export const Modal = ({ isOpen, setOpen }: WalletModalProps) => {
      ...
      <Dialog as="div" className="relative z-10" onClose={onCloseModal}>
        ...
        <div className="fixed inset-0 z-10 overflow-y-auto">
          <div className="flex items-end justify-center min-h-full p-4 text-center sm:items-center sm:p-0">
            ...
            >
              <Dialog.Panel className="relative transform overflow-hidden rounded-xl bg-white dark:bg-black px-4 pt-5 pb-4 [min-height:18rem] text-left shadow-xl transition-all sm:my-8 max-w-7xl w-full sm:w-full sm:max-w-sm sm:p-4">
