...
export const Address = ({ children: address }: { children: string }) => {
  ...
  return (
    <button
      className="inline-flex items-center justify-center px-6 py-1 mx-4 mb-4 space-x-2 text-sm text-gray-500 bg-white border rounded-full dark:text-white/75 dark:bg-black border-black/10 dark:border-white/10 hover:bg-zinc-200 dark:hover:bg-white/10 hover:border-zinc-200 dark:hover:border-white/10"
      onClick={() => {
  ...
  return (
    <div className="mt-3 text-center sm:mt-1.5 sm:text-left">
      ...
      <div className="flex flex-col justify-between w-full h-full px-2 pt-4 pb-8 mt-4">
        ...
        <button
          className="rounded-lg bg-primary-500 hover:bg-primary-500/75 inline-flex justify-center items-center py-2.5 font-medium text-white"
          onClick={() => {
