...
export const inputClassNames = {
  base: [
    'shadow-sm sm:text-sm block w-full rounded-lg bg-white dark:bg-black text-black dark:text-white',
  ...
  valid:
    'border-neutral-300 dark:border-neutral-600 focus:border-neutral-300 dark:focus:border-neutral-600',
  invalid:
    'text-red-900 dark:text-red-200 border-red-400 dark:border-red-500 focus:border-red-400 dark:focus:border-red-500',
}
      ...
      <div className="relative rounded-md shadow-sm">
        ...
        {trailingAddon && (
          <div className="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none">
            <span
              className="text-neutral-500 dark:text-neutral-400 sm:text-sm"
              id={`${id}-addon`}
            >
              {trailingAddon}
            </span>
