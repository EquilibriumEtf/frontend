...
export const Navbar = ({ navigation }: { navigation: NavigationItem[] }) => {
          ...
          <div className="px-2 mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div className="relative flex justify-center h-16 sm:justify-between">
              ...
              <div className="flex items-center justify-center flex-1 sm:items-stretch sm:justify-start">
                <div className="flex items-center flex-shrink-0 pr-6 sm:border-r sm:border-black/10 dark:sm:border-white/10">
                  <Link href="/">
                    <a>
                      <img
